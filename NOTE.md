...
3. 找个NSFC 2026的 latex 模板，形成完整一稿
    ...
    2. [Online latex project](https://www.onlinelatex.com/project/697085f5b507200f4a4e7c36)
        1. 到时候贴进去文本试一下
        2. **成功实现了把各个章节切分成单独文件**，这么写比较清楚，不是所有内容对在一起
        3. 实现了引用编号为上标
        4. 【采用此模板】
...
5. 国内外研究现状卡壳太久了，要开始画图了
    1. 先画什么图？
        0. 点云感知任务
            - 这个图要画吗？该怎么画，参考之前看的论文，寻找灵感
                - **可能要跑些可视化的实验**
        1. 整体研究框架，这个图非常重要，在纸上画个草图
        2. 技术路线图，比整体框架图更详细一些
            - 2026/02/07 画这个图
            - 点云可视化怎么弄？之前积累了不少github项目，从那里找，另外就是从经典论文截图
