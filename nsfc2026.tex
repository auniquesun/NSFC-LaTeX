...
%\if 0
\begin{center}\bf\Large 开放环境下检索增强的3D点云测试时自适应分析方法研究 \\

Research on Retrieval-augmented Test-time Adaptation for 3D Point Cloud Analysis in Open World 
\end{center}
...
\myPara{申请平台概况}
内蒙古大学
作为教育部和内蒙古自治区部省共建重点大学，一系列优良研究平台。
...
团队成员受邀担任IEEE TPAMI, IJCV, IEEE CVPR, NeurIPS 等本领域
多个顶级期刊和会议的审稿人。
